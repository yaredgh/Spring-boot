package edu.mum.recipe.project.recipe.DataLoaderBootstrap;

import edu.mum.recipe.project.recipe.modles.*;
import edu.mum.recipe.project.recipe.repo.CategoryRepo;
import edu.mum.recipe.project.recipe.repo.RecipeRepo;
import edu.mum.recipe.project.recipe.repo.UnitMeasureRepo;
...
public class Bootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private final UnitMeasureRepo unitOfMeasureRepository;

    public Bootstrap(CategoryRepo categoryRepository, RecipeRepo recipeRepository, UnitMeasureRepo unitOfMeasureRepository) {
    ...
    private List<Recipe> getRecipes() {
        ...
        //get UOMs
        Optional<UnitMeasure> eachUomOptional = unitOfMeasureRepository.findByUom("Each");

        if (!eachUomOptional.isPresent()) {
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<UnitMeasure> tableSpoonUomOptional = unitOfMeasureRepository.findByUom("Tablespoon");

        if (!tableSpoonUomOptional.isPresent()) {
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<UnitMeasure> teaSpoonUomOptional = unitOfMeasureRepository.findByUom("Teaspoon");

        if (!teaSpoonUomOptional.isPresent()) {
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<UnitMeasure> dashUomOptional = unitOfMeasureRepository.findByUom("Dash");

        if (!dashUomOptional.isPresent()) {
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<UnitMeasure> pintUomOptional = unitOfMeasureRepository.findByUom("Pint");

        if (!pintUomOptional.isPresent()) {
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<UnitMeasure> cupsUomOptional = unitOfMeasureRepository.findByUom("Cup");
